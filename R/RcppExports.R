...
ld2df_p <- function(scaled_data, mapd, rsid, m, Ne, cutoff, r2cutoff = 0.01, progress = FALSE) {
    .Call(`_LDshrink_ld2df_p`, scaled_data, mapd, rsid, m, Ne, cutoff, r2cutoff, progress)
}
